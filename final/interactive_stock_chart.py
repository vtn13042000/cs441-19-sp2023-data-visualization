...
def graph_for_single_ticker(stock_code, interval = "1m", period = "1d"):
  ...
  print("*" * 20)
  print(f"This if the total data extract from the source: {len(df)}")
  print("*" * 20)
...
if __name__ == "__main__":
    # app.run_server(debug= False, port = 9900)
